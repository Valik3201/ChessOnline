# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-05-21 13:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField()),
                ('datetime', models.DateTimeField()),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Chess.Article')),
            ],
        ),
        migrations.CreateModel(
            name='Game',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('games', models.ManyToManyField(blank=True, to='Chess.Game')),
        ...
        migrations.AddField(
            model_name='comment',
            name='game',
            field=models.ManyToManyField(to='Chess.Game'),
        ),
        migrations.AddField(
            model_name='article',
            name='author',
